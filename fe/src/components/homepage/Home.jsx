...
const Home = () => {
    ...
    <div className="stat items">
        <div className="stat-figure text-primary">
            <svg className="w-11 h-11 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <div className="stat-title">Total Karyawan</div>
    ...
    <div className="stat">
        ...
        <div className="stat-title">Karyawan hadir</div>
    ...
    <div className="stat">
        ...
        <div className="stat-title">Karyawan tidak Hadir</div>
        <div className="stat-value">10</div>
    </div>
</div>

                <div className="flex items-center justify-center rounded mt-24">
                    <Table />
                </div>
                <div className="grid grid-cols-1 gap-4 mb-4 mt-6 sm:grid-cols-2">
